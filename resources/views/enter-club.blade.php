                ...
                <div class="page-header">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Clubbing</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="main-content-body main-content-body-chat h-100">
                                    <div class="main-chat-header pt-3 d-block d-sm-flex">
                                        <div class="main-img-user chat-user">
                                            @if(isset($det) && $det->profile_pic!='')
                                            <img src="{{ asset('assets/images/staff-students/')}}/{{$det->profile_pic}}"
                                            alt="profile-user">
                                            @else
                                    ...
                                    <div class="main-chat-body flex-2 ps ps--active-y" id="ChatBody"
                                        ...
                                        <div class="content-inner chat-body">
                                            @foreach ($msgs as $msg)
                                            @if($msg->from_id==$mine->unique_key)
                                             <div class="media flex-row-reverse chat-right">
                                                ...
                                                <div class="media-body">
                                                    <div class="main-msg-wrapper">
                                                        {{$msg->msg}}
                                                        @if($msg->file!=null)
                                                            <em class="ml-2"><a href="{{asset('assets/club')}}/{{$msg->file}}" target="_blank" class="text-primary">(File)</a></em>
                                                        @endif
                                                    </div>
                                                    <div>
                                            ...
                                            @else
                                            @php
                                                $usr = DB::table('users')->where('unique_key',$key)->first();
                                                $more  = DB::table('user_more')->where('user_id',$usr->id)->first();
                                            @endphp
                                            <div class="media chat-left">
                                                <div class="main-img-user chat-user">
                                                   ...
                                                   <a href="">
                                                    ...
                                                    @else
                                                    <a href="">{{strtoupper($usr->username[0])}}</a>
                                                    @endif
                                                </div>
                                                <div class="media-body">
                                                    <div class="main-msg-wrapper">
                                    ...
                                    <form class="main-chat-footer" id="club-form" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="to_id" value="{{$key}}">
