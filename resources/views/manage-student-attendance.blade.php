    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Manage Student Attendance</h1>
                <div>
                    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                            ...
                                            <tr>
                                                ...
                                                <td><a target="_blank" href="{{url('admin/student-attendance')}}/{{$user->id}}">{{ $user->username }}</a></td>
                                                @else
                                                <td><a target="_blank" href="{{url('staff/student-attendance')}}/{{$user->id}}">{{ $user->username }}</a></td>
                                                @endif
                                                <td>
                                                    @if ($more->profile_pic != '')
                                                        <a target="_blank"
