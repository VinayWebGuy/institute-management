...
@section('title', 'Today PTE score summary')
@section('pte', 'active')
@section('content')
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Today PTE score summary</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">PTE</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Today PTE score summary</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h3 class="card-title col-md-8">Today PTE score summary</h3>
                            </div>
                            <div class="card-body">
