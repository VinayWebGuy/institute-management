    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                Copyright © 2022 <a href="javascript:void(0)">Key2Success</a>. Designed with <span
                    class="fa fa-heart text-danger"></span> by <a href="https://www.instagram.com/the.anonymous.lad/" target="_blank"> Vinay </a> All
                rights reserved.
            </div>
        </div>
    </div>
