...
<head>
    ...
    <meta name="description" content="A IELTS PTE Portal by Key2Success">
    ...
    <!-- TITLE -->
    <title>Lockscreen – Key2Success</title>
            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                            ...
                            <form method="post" action="{{url('lockscreen')}}">
                                @csrf
                            ...
                            <div class="text-center pt-2">
                                ...
                                <a class="" href="{{url('forget-password-on-lockscreen')}}">
										Reset Password
									</a>
                            </div>
