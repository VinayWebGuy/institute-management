            ...
            <div class="main-container container-fluid">
                ...
                @if ($selected)
                    @if (Session::get('role') == 1)
                        <form method="post" action="{{ route('admin.add-enquiry') }}" enctype="multipart/form-data">
                        @else
                            <form method="post" action="{{ route('staff.add-enquiry') }}" enctype="multipart/form-data">
                    @endif
                    @csrf
                @endif
                @if (!$selected)
                        ...
                        <div class="col-md-12 col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        @if (Session::get('role') == 1)
                                            <a href="{{ url('admin/add-enquiry') }}" class="mr-2 text-red">
                                                <i class="fe fe-corner-up-left"></i>
                                            </a>
                                        @else
                                            <a href="{{ url('staff/add-enquiry') }}" class="mr-2 text-red">
                                                <i class="fe fe-corner-up-left"></i>
                                            </a>
                                        @endif
                                        IELTS ENQUIRY
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" class="form-control number-without-arrow" name="mobile"
                                                id="mobile">
                                        </div>
                                         <div class="form-group col-md-3">
